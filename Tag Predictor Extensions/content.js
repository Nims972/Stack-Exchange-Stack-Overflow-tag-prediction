...
function msg(message, sender, sendResponse) {
    if (message.txt == "search") {
        ...
        xhttp.onreadystatechange = function() {
            ...
            //alert(tags[0]);
            console.log(tags)
            document.getElementsByClassName('grid--cell py8 px16 mr4 s-link js-wz-progress wz-progress')[0].click();
        ...
        xhttp.open("GET", "http://127.0.0.1:5000/" + document.domain + "/" + t, true);
        xhttp.send();
        //if(flag == 1)
